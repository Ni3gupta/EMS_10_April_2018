								...
								<table class="table table-hover table-bordered tbl">
									...
									<tr>
										...
										<td>  <a href="#" data-toggle="modal"
											...
											<form><input type="text" class="hidden" id="delete" value=<%=u.getCompany_ID()%>></input></form>
											<button type="submit"
												style="color: red;" href="#" data-toggle="modal"
												data-target="#myModal2" class="fa fa-close"
												></button>
...
immediately after /labele control sidebar -->
	...
	$(document).ready(function(){ 
        ...
        var set = document.getElementById('delete').value;
